...
enum { NetSupported, NetWMName, NetWMState, NetWMCheck, NetWMFullscreen,
       NetNumberOfDesktops, NetCurrentDesktop, NetActiveWindow, NetWMWindowType,
...
unmanage(Client *c, int destroyed)
{
	...
	XClassHint ch = { NULL, NULL };
	int is_brave = XGetClassHint(dpy, c->win, &ch) && ch.res_class && (strcmp(ch.res_class, "Brave-browser") == 0);
